...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $dirFinder = sfFinder::type('dir')->discard('.sf', '/\.gitignore$/')->maxdepth(0)->relative();
    ...
    {
      $this->getFilesystem()->remove(sfFinder::type('file')->discard('.sf', '/\.gitignore$/' )->in(sfConfig::get('sf_cache_dir')));
    }
  }
  ...
  protected function clearConfigCache(sfApplicationConfiguration $appConfiguration)
  {
    ...
    {
      // remove cache files
      $this->getFilesystem()->remove(sfFinder::type('file')->discard('.sf', '/\.gitignore$/')->in($subDir));
    }
  }
